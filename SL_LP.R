...
nasproblem <- c(341, 457, 664, 1292, 1467, 1827, 1926)
...
singlevar_data <- dplyr::select(data, totalpurchases, mntwines, mntfruits, mntmeatproducts, 
...
clustering_datas <- dplyr::select(clustering_data, -mntfishproducts, -mntmeatproducts,
...
categoricals <- dplyr::select(data, education, marital_status, acceptedcmp3:acceptedcmp2, response, complain)
